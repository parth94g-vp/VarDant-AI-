...
def load_models():
    ...
    model = joblib.load(os.path.join(BASE_DIR, "fertilizer_category_model.pkl"))
    soil_encoder = joblib.load(os.path.join(BASE_DIR, "fertilizer_soil_encoder.pkl"))
    crop_encoder = joblib.load(os.path.join(BASE_DIR, "fertilizer_crop_encoder.pkl"))
    category_encoder = joblib.load(os.path.join(BASE_DIR, "fertilizer_category_encoder.pkl"))
